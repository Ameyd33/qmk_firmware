...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SOLIDWORKS] = LAYOUT_2(
        KC_NO,  KC_NO,  MENU_KEY,  KC_F,
        LCTL(KC_1),   LCTL(KC_2),   LALT(KC_3), KC_G,
        LCTL(KC_4),   LCTL(KC_4),  LCTL(KC_8),  LCTL(KC_8)
    )
};
...
bool encoder_update_user(uint8_t index, bool clockwise) {
    ...
    switch (current_layer) {
        ...
        case _APPS:
            ...
            break;
        case _SOLIDWORKS:
            tap_code(clockwise ? KC_Z : LALT(KC_Z));
        break;
...
static uint8_t last_state = 255;
   ...
   if (menu_active) {
        ...
        oled_write_ln_P(menu_index == _KICAD   ? PSTR("> KI-CAD")    : PSTR("  KI-CAD"),    false);
        oled_write_ln_P(menu_index == _APPS    ? PSTR("> APPS")    : PSTR("  APPS"),    false);
         oled_write_ln_P(menu_index == _SOLIDWORKS   ? PSTR("> SOLIDWORKS")    : PSTR("  SOLIDWORKS"),    false);
